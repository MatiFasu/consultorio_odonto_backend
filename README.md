...
- `/consultorio_odontologico`: Código fuente del Frontend (React + Vite).
- `/consultorioOdontologico`: Código fuente del Backend (Spring Boot).
- `docker-compose.yml`: Configuración para orquestación de contenedores (Backend + DB).
...
Desarrollado con ❤️ para mejorar la gestión odontológica.
